    ...
    Scaffold(
        ...
        if (state.isLoading) {
            ...
            Column(
                ...
                // Main Total Card
                MainTotalCard(state.totalAnimals.toString(), tealPrimary)
                ...
                Row(
                    ...
                    StatCard(
                        modifier = Modifier.weight(1f),
                        value = state.inTreatmentCount.toString(),
                        label = "EM TRATAMENTO",
...
@Composable
fun MainTotalCard(total: String, tealColor: Color) {
    Card(
        modifier = Modifier.fillMaxWidth(),
...
fun PopulationCard(
    dogsCount: Int,
    dogsPercentage: Float,
    catsCount: Int,
    catsPercentage: Float,
    darkBlue: Color,
    grayText: Color,
    tealColor: Color
) {
    Card(
        ...
        Column(modifier = Modifier.padding(20.dp)) {
            ...
            SpeciesProgress("🐶 Cachorros", dogsCount.toString(), dogsPercentage, tealColor)
            Spacer(modifier = Modifier.height(16.dp))
            SpeciesProgress("🐱 Gatos", catsCount.toString(), catsPercentage, Color(0xFFFFA000))
        }
    }
}
