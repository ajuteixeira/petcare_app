...
fun MovementHistoryScreen() {
    ...
    Scaffold(
        ...
        bottomBar = {
            MovementHistoryBottomNavigation(tealPrimary)
        },
...
@Composable
fun MovementHistoryBottomNavigation(tealPrimary: Color) {
    NavigationBar(
        containerColor = Color.White,
        tonalElevation = 8.dp
    ) {
        val items = listOf("Animais", "Dashboard", "Exportar", "Adicionar")
        val icons = listOf(Icons.Default.Home, Icons.Default.BarChart, Icons.Default.FileDownload, Icons.Default.AddCircleOutline)
        
        items.forEachIndexed { index, item ->
            val isSelected = item == "Animais"
            NavigationBarItem(
...
@Composable
fun MovementHistoryScreenPreview() {
